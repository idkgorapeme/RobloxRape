...
local blue1  = { CFrame = CFrame.lookAt((Vector3.new(3390,600,3904)+Vector3.new(3295,648,5191))/2, Vector3.new(3295,648,5191)), Size = Vector3.new(40,1,(Vector3.new(3295,648,5191)-Vector3.new(3390,648,3904)).Magnitude) }
